    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="RangeValidator" ValidationGroup="group2" 
                MinimumValue="01.01.2011" MaximumValue="31.12.2011" ControlToValidate="TextBox3" ForeColor="Red" Type="Date">Ошибка диапазона TextBox3</asp:RangeValidator>
            <br />
        </div>
        ...
        <div>
            <asp:Label runat="server" Text="6. Форма для проверки ValidationSummary"></asp:Label> 
            <br />
            <table>
                <tr>
                    <td>
